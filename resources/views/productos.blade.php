...
<div class="fondo pb-2">
    ...
    <div class="container py-5">
        ...
        <div class="row row-cols-3 justify-content-evenly align-items-center g-4">
            <!-- card reel1 -->
            <div class="col-sm-3">
                <div class="shadow-sm text-center p-2 product-card">
                    ...
                    <h5 class="fw-semibold fs-6 fs-sm-3 mb-0">Reel Frontal Daiwa Sweepfire 4000</h5>
                </div>
            </div>
            <!-- card reel2 -->
            <div class="col-sm-3">
                <div class="shadow-sm text-center p-2 product-card">
                    ...
                    <h5 class="fw-semibold fs-6 fs-sm-3 mb-0">Reel Rotativo Abu Garcia Black Max</h5>
                </div>
            </div>
            <!-- card reel3 -->
            <div class="col-sm-3">
                <div class="shadow-sm text-center p-2 product-card">
                    ...
                    <h5 class="fw-semibold fs-6 fs-sm-3 mb-0">Reel Rotativo Penn Squall Level Wind</h5>
                </div>
            </div>  
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row row-cols-3 justify-content-evenly align-items-center g-4">
            <!-- card caña1 -->
            <div class="col-sm-3">
                <div class="border shadow-sm text-center p-2 product-card">
                    <div class="mx-auto mb-1 overflow-hidden shadow-sm" style="width: 100%; height: 100%;">
                    ...
                    <h5 class="fw-semibold fs-6 fs-sm-3 mb-0">Caña Telescópica Shimano FX (3.00m)</h5>
            ...
            <div class="col-sm-3">
                <div class="border shadow-sm text-center p-2 product-card">
                    ...
                    <h5 class="fw-semibold fs-6 fs-sm-3 mb-0">Caña Baitcasting Marine Sports Titan (1.98m)</h5>
                </div>
            </div>
            <!-- card caña3 -->
            <div class="col-sm-3">
                <div class="border shadow-sm text-center p-2 product-card">
                    ...
                    <h5 class="fw-semibold fs-6 fs-sm-3 mb-0">Caña de Mosca Waterdog Fly Series (#5)</h5>
                </div>
            </div>  
        </div>
    </div>
        ...
        <div class="row row-cols-3 justify-content-evenly align-items-center g-4">
            ...
            <div class="col-sm-3">
                <div class="shadow-sm text-center p-2 product-card">
                    ...
                    <h5 class="fw-semibold fs-6 fs-sm-3 mb-0">Señuelo Rapala Super Shad Rap (14cm)</h5>
                </div>
            </div>
            <!-- card herramienta2 -->
            <div class="col-sm-3">
                <div class="shadow-sm text-center p-2 product-card">
                    <div class="mx-auto mb-1 overflow-hidden shadow-sm" style="width: 100%; height: 100%;">
                        <img src="{{ asset('img/catalogo/señuelo2.jpg') }}" class="w-100 h-100 ">
                    </div>
                    <h4 class="text-success fs-6 fs-sm-3 fw-bold mb-0">$12.500</h4>
                    <h5 class="fw-semibold fs-6 fs-sm-3 mb-0">Señuelo Cuchara Giratoria Mepps Aglia (N°4)</h5>
                </div>
            </div>
            <!-- card herramienta3 -->
            <div class="col-sm-3">
                <div class="shadow-sm text-center p-2 product-card">
                    <div class="mx-auto mb-1 overflow-hidden shadow-sm" style="width: 100%; height: 100%;">
                        <img src="{{ asset('img/catalogo/hilo.jpg') }}" class="w-100 h-100 ">
                    </div>
                    <h4 class="text-success fs-6 fs-sm-3 fw-bold mb-0">$48.000</h4>
                    <h5 class="fw-semibold fs-6 fs-sm-3 mb-0">Hilo Multifilamento Sufix 832 (Rollo 150m)</h5>
                </div>
            </div>  
        </div>
        <div class="row row-cols-3 justify-content-evenly align-items-center g-4 mt-1">
            <!-- card herramienta4 -->
            <div class="col-sm-3">
                <div class="shadow-sm text-center p-2 product-card">
                    <div class="mx-auto mb-1 overflow-hidden shadow-sm" style="width: 100%; height: 100%;">
                    ...
                    <h5 class="fw-semibold fs-6 fs-sm-3 mb-0">Caja de Anzuelos Mustad Serie 92247 (x50 unidades)</h5>
                </div>
            </div>
            <!-- card herramienta5 -->
            <div class="col-sm-3">
                <div class="shadow-sm text-center p-2 product-card">
                    ...
                    <h5 class="fw-semibold fs-6 fs-sm-3 mb-0">Caja de Pesca Plano 3 Bandejas Articuladas</h5>
                </div>
            </div>
            <!-- card herramienta6 -->
            <div class="col-sm-3">
                <div class="shadow-sm text-center p-2 product-card">
                    <div class="mx-auto mb-1 overflow-hidden shadow-sm" style="width: 100%; height: 100%;">
                        <img src="{{ asset('img/catalogo/pinza.jpg') }}" class="w-100 h-100 ">
                    </div>
                    <h4 class="text-success fs-6 fs-sm-3 fw-bold mb-0">$22.000</h4>
                    <h5 class="fw-semibold fs-6 fs-sm-3 mb-0">Pinza de Pesca Multifunción Spinit (Acero Inox)</h5>
                </div>
            </div>  
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row row-cols-3 justify-content-evenly align-items-center g-4">
            ...
            <div class="col-sm-3">
                <div class="border shadow-sm text-center p-2 product-card ">
                    <div class="mx-auto mb-1 overflow-hidden shadow-sm" style="width: 100%; height: 100%;">
                        <img src="{{ asset('img/catalogo/bolso.jpg') }}" class="w-100 h-100 ">
                    </div>
